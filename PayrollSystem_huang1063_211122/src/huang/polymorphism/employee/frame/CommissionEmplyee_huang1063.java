...
public class CommissionEmplyee_huang1063 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CommissionEmplyee_huang1063 frame = new CommissionEmplyee_huang1063();
